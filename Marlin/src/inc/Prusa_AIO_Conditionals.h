...
//===========================================================================
  ...
  #define PIDTEMP
    ...
    #elif ENABLED(PRUSA_AIO_HOTEND_E3D_REVO_MICRO)
      #define PRUSA_AIO_DEFAULT_Kp   20.4  // 40.587
      #define PRUSA_AIO_DEFAULT_Ki    3.99 // 4.163
      #define PRUSA_AIO_DEFAULT_Kd   26.1  // 98.932
    #elif ENABLED(PRUSA_AIO_HOTEND_E3D_REVO_SIX)
      #define PRUSA_AIO_DEFAULT_Kp  25.00
      #define PRUSA_AIO_DEFAULT_Ki   4.8
      #define PRUSA_AIO_DEFAULT_Kd  32.60
    #else
